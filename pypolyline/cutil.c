...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            "./pypolyline",
            "pypolyline",
            "/Users/sth/dev/pypolyline/venv/lib/python3.9/site-packages/numpy/core/include"
        ],
        "language": "c",
        "libraries": [
            "polyline_ffi"
 ...
 */
  ...
  __pyx_t_4 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)__pyx_v_result.len), ((Py_ssize_t)2)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);

...
if not 'win32' in platform:
    ...
    with open('key.txt', 'r') as f:
        ghkey = f.read().strip()
        path = os.path.join(os.environ['HOME'], "build/urschrei/pypolyline/pypolyline")
elif 'win32' in platform:
    ghkey = os.environ['TARBALL_KEY']
    path = "C:\projects\pypolyline\pypolyline"

# Get the latest release details for the binary
project = 'polyline-ffi'
